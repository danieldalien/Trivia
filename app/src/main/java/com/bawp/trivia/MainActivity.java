...
public class MainActivity extends AppCompatActivity {
    ...
    private void updateScoreSucess(){
        binding.scoreSucessTextView.setText(String.valueOf(scoreSuccess));
    }

    private void updateScoreFail(){
        binding.scoreFailTextView.setText(String.valueOf(scoreFail));
    }
